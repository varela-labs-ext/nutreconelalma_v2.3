...
interface StaffSalaryHeadersProps {
    title?: string;
}

const StaffSalaryHeaders = (props: StaffSalaryHeadersProps) => {
    return (
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-4 gap-2 w-full pt-4 pb-4 font-medium">
                        <div className="md:col-span-2 w-full text-left">
                            <div className=" dark:text-white">
                                <p>{props.title ? props.title : "Detalle de la compensación salarial"}</p>
                            </div>
                        </div>
...
export default StaffSalaryHeaders;